...
class NewUser extends Notification
{
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
                    ->subject('Tu cuenta en Discovery Plataforma de Portabilidad esta lista!')
                    ->greeting("Hola! ".$this->data['nombre_apellido']." Bienvenido al equipo!")   
                    ...
                    ->line(new HtmlString("<b>Usuario</b>: ".$this->data['usuario']))
                    ->line(new HtmlString("<b>Password</b>: ".$this->data['password']))
                    ->action('Vamos', url('/'))
                    ->salutation('Atentamente, Portabilidad Team');
    }
