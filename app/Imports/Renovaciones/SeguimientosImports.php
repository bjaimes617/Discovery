...
class SeguimientosImports implements ToCollection, WithChunkReading, WithHeadingRow, WithValidation
{
    ...
    public function collection(Collection $collection)
    {
        ...
        $ventas    = renovacionesVentasModel::whereIn('numero_orden_onix', $ordenOnix)
            ->where('estatus_id', '!=', 11)
            ->pluck('id', 'numero_orden_onix');
        $Update = array();
        ...
        foreach ($collection as $seguimiento) {
            ...
            if (isset($ventas[$seguimiento["orden_onix"]])) {
                ...
                $Update[] = [
                    ...
                    "tripleta"          => $seguimiento['tripleta']         != null ? strtoupper($seguimiento['tripleta']) : null,
