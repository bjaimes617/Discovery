...
class CreateVentasClaroMovilTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('ventas_claro_movil', function (Blueprint $table) {
            ...
            $table->string('equipo')->comment('propio o alquilado');
            $table->text('direccion'); 
            $table->string('numero_alterno1');
            $table->string('numero_alterno2');
            $table->date('fecha_venta');
            $table->unsignedBigInteger('tipo_envio_id')->nullable()->unsigned()->index();            
            $table->foreign('tipo_envio_id')->references('id')->on('cl_tipo_envio')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('ventas_claro_movil');
    }
}
