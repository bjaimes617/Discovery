@if(Session::has('errorVentas') || count($errors) > 0)
<div class="row">
    <div class="col">
        <div class="alert alert-outline-danger alert-elevate fade show" role="alert">
            ...
            <div class="alert-text">
                <ul>
                    @if(Session::has('errorVentas'))
                    <li>{!!Session::get('errorVentas')!!}</li>
                    @endif                      
...
@endif
@if(Session::has('warningVentas'))
<div class="row">
    <div class="col">
        <div class="alert alert-outline-info alert-elevate fade show" role="alert">
            <div class="alert-icon"><i class="flaticon-warning kt-font-info"></i></div>
            <div class="alert-text">
               <ul class="text-info">                   
                    @foreach(Session::get('warningVentas') as $error)                    
                    <li>{!!$error!!}</li>
                    @endforeach
                </ul>
            </div>
