...
@section('title','Claro Masivos|Auditoria')
@section('content')
<!-- begin:: Subheader -->
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="kt-portlet">
                ...
                <form action="{{ route('claro.masivos.auditoriaStore', $venta->id) }}" id="zz" method="POST" class="kt-form kt-form--label-right">
                    @csrf
                    @method('PUT')
                    <div class="kt-portlet__body text-center">      
                        <div class="form-group row">
                            ...
                            <div class="col-lg-7 col-md-12 col-sm-12">
                               <div class="input-group">                                    
                                    <select name="producto" id="producto" required data-href="{{ route('claro.masivos.getPlanes') }}"  class="select form-control">                                                   
                            ...
                            <div class="form-group row">
                                ...
                                <div class="input-group">                                    
                                        <select name="tipoventa" id="tipoventa" @if($venta->tipo_venta == "Hogar") Disabled @endif class="select form-control" style="width: 100%;">                                                   
                                            <option value="">[Seleccione]</option>
                                            @foreach($tipo_venta as  $keys => $tipo_ventas)
                                            <option value="{{$tipo_ventas}}" @if($venta->tipo_venta !== null && $venta->tipo_venta == $tipo_ventas) selected @endif>{{$tipo_ventas}}</option> 
                                            @endforeach   
                                        </select>                                           
                                    </div> 
                                </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-7 col-md-12 col-sm-12">
                                <input type="text" name="agencia" id="agencia" class="form-control" disabled value="Directa Group" required placeholder="Razon Social de la Agencia">                                
                            </div>
                        </div> 
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-7 col-md-12 col-sm-12">
                                <div class="input-group"> 
                                    <input type="text" name="apellido1" id="apellido1" class="form-control" value="{{ $venta->apellido_1 }}"  required placeholder="1er Apellido de la Persona">                                                                                                                                   
                                </div>    
                            </div>
                        </div> 
                        <div class="form-group row">
                            ...
                            <div class="col-lg-7 col-md-12 col-sm-12">
                                <div class="input-group">                                     
                                    <input type="text" name="apellido2" id="apellido2" class="form-control" value="{{ $venta->apellido_2 }}"  required placeholder="2do Apellido de la Persona"> 
                                </div>    
                            </div>
                        </div> 
                        <div class="form-group row">
                            ...
                            <div class="col-lg-7 col-md-12 col-sm-12">
                                <input type="text" name="identificacion" id="identificacion" class="form-control" value="{{ $venta->identificacion }}"  required placeholder="Identificador">                                                                                                
                            </div>
                        </div> 
                        <div class="form-group row">
                            ...
                            <div class="col-lg-7 col-md-12 col-sm-12">
                               <div class="input-group">
                                    ...
                                    <select name="tipo_cliente" id="tipo_cliente" required class="form-control">                                                   
                                        <option value="">[Seleccione]</option>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-7 col-md-12 col-sm-12">
                                <input type="text" name="provincia" id="provincia" value="{{ $venta->provincia }}" class="form-control" required placeholder="Provincia">                                                                                                
                            </div>
                        </div> 
                        <div class="form-group row">
                            <label class="col-form-label col-lg-4 col-sm-12" for="canton">Canton *</label>
                            <div class="col-lg-7 col-md-12 col-sm-12">
                                <input type="text" name="canton" id="canton" value="{{ $venta->canton }}" class="form-control" required placeholder="Provincia">                                                                                                
                            </div>
                        </div> 
                        <div class="form-group row">
                            <label class="col-form-label col-lg-4 col-sm-12" for="distrito">Distrito *</label>
                            <div class="col-lg-7 col-md-12 col-sm-12">
                                <input type="text" name="distrito" id="distrito" value="{{ $venta->distrito }}" class="form-control" required placeholder="Distrito">                                                                                                
                            </div>
                        </div> 
                        <div class="form-group row">
                            ...
                            <div class="col-lg-7 col-md-12 col-sm-12">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="direccion" id="direccion" value="{{ $venta->detalle_direccion }}" class="form-control" required placeholder="Direccion Exacta">                                                                                                
                                </div>
                            </div>
                        </div> 
                        <div class="form-group row">
                            ...
                            <div class="col-lg-7 col-md-12 col-sm-12">
                                <div class="input-group">                                    
                                    ...
                                    <input type="text" name="telefono" id="telefono" value="{{ $venta->telefono_a_llamar }}" class="form-control input-number" maxlength="15" required placeholder="Numero Telefonico de Contacto">                                                                                                                                    
                                </div>    
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-lg-7 col-md-12 col-sm-12">
                                <div class="input-group">                                    
                                    <div class="input-group-prepend">
                                        ...
                                        <input type="text" type="email" name="email" value="{{ $venta->email }}" id="email" class="form-control col-lg-12 col-md-12 col-sm-12" required placeholder="example@example.com">                                     
                                </div>    
                            </div>
                        </div>                         
                        <div class="form-group row">
                            ...
                            <div class="col-lg-7 col-md-12 col-sm-12">
                               <div class="input-group">
                                    ...
                                    <select name="equipo" id="equipo" required class="form-control">                                                   
                                        <option value="">[Seleccione]</option>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-7 col-md-12 col-sm-12">
                                <input  type="text" name="numero_portar" id="numero_portar" value="{{ $venta->numero_portar }}" class="form-control" required placeholder="Numero a Portar">                                                                                                
                            </div>
                        </div> 
                        <div class="form-group row">
                            ...
                            <div class="col-lg-7 col-md-12 col-sm-12">
                               <div class="input-group">
                                    ...
                                    <select name="anticipo" id="anticipo" required class="form-control">                                                   
                                        <option value="">[Seleccione]</option>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-7 col-md-12 col-sm-12">
                                <div class="input-group">                                    
                                    ...
                                    <input type="text"  name="nombreref1" id="nombreref1" value="{{ $venta->nombre_refencia_1 }}"  class="form-control" required placeholder="Nombre y Apellido">                                                                                                                                    
                                </div>    
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-7 col-md-12 col-sm-12">
                                <div class="input-group">                                    
                                    ...
                                    <input type="text"  name="nombreref2" id="nombreref2" value="{{ $venta->nombre_refencia_2 }}"  class="form-control" placeholder="Nombre y Apellido">                                                                                                                                    
                                </div>    
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-7 col-md-12 col-sm-12">
                                <div class="input-group">                                    
                                    ...
                                    <input type="text" name="nombreref3" id="nombreref3" class="form-control"  
                                    value="{{ $venta->nombre_refencia_3 }}"  placeholder="Nombre y Apellido">                                                                                                
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-7 col-md-12 col-sm-12">
                                <div class="input-group">                                    
                                    ...
                                    <input type="text" name="telefonoref3" id="telefonoref3" value="{{ $venta->telefono_refencia_3 }}"  
                                    class="form-control input-number" placeholder="Telefono 1"> 
                                </div>    
                            </div>
                        </div>
                        <div class="form-group row">
                    ...
                    <div class="kt-portlet__foot">
                        <div class="kt-form__actions">
                            <div class="row">
                                <div class="col-lg-12 ml-lg-auto btn-group">
                                    <button type="submit"  value="aprobada" class="btn btn-brand ">Aprobar</button>
                                    <button type="submit"  value="rechazada" class="btn btn-danger">Rechazar</button>
                                </div>
                            </div>
                        </div>
                    </div>
                    <input type="hidden" name="auditoriatext" id="auditoriatext"  class="form-control"> 
                    <input type="hidden" name="recuperable" id="recuperable"  class="form-control"> 
                    <input type="hidden" name="auditoria" id="auditoria"  class="form-control"> 
                </form>
            </div>
        </div>
    </div>
