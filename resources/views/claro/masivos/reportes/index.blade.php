...
@section('title','Claro Masivo|Reporte de Gestión')
@section('content')
<!-- begin:: Subheader -->
        ...
        <div class="col-lg-12">
            ...
            <div class="kt-portlet">
                ...
                <div class="kt-portlet__body">        
                    <form method="POST" action="{{ route('claro.masivos.reportesData') }}" id="formReportes" class="kt-form kt-form--label-right">
                        @csrf      
                        <div class="row">
