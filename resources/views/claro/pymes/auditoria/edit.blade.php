...
@section('title','Claro Pymes|Auditoria')
@section('content')
<!-- begin:: Subheader -->
                ...
                <div class="kt-portlet__head">
                    <div class="kt-portlet__head-label">
                        <h3 class="kt-portlet__head-title">
                            Pymes - Auditoria de la Venta
                        </h3>
                    </div>
                </div>
                <form method="POST" action="{{ route('claro.pymes.auditoriaStore',$venta->id) }}" id="AuditoriaUpdate" class="kt-form kt-form--label-right">
                    @csrf
                    @method('PUT')
                    <div class="kt-portlet__body text-center">  
                        <div class="form-group row">
                            ...
                            <div class="col-lg-7 col-md-7 col-sm-12">
                                <input type="text" name="idcontacto" id="idcontacto" class="form-control" value="{{ $venta->id_contacto }}" required placeholder="ID Contacto de Respond.io">                                
                            </div>
                        </div>   
                        <div class="form-group row">
                        ...
                        <div id="divAfiliados" @if($venta->tipo_venta === "0") style="" @else style="display:none;" @endif>
                            <div class="form-group row">
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-12">
                                    <input type="text name="cedulatitular" id="cedulatitular" value="{{ $venta->tipo_venta === "0" ? $venta->identificacion : ""}}" class="input-number form-control" placeholder="Cedula Titular">
                                </div>
                            </div> 
                            <div class="form-group row">
                                <label class="col-form-label col-lg-4 col-sm-12" for="ordenpatronal">Orden Patronal *</label>
                                <div class="col-lg-7 col-md-7 col-sm-12">
                                    <input type="text name="ordenpatronal" id="ordenpatronal" value="{{ $venta->tipo_venta === "0" ? $venta->ordenpatronal : ""}}" class="form-control" placeholder="Orden Patronal">
                                </div>
                            </div> 
                        </div>
                        <!--DIV PYMES-->
                        ...
                        <div id="divpymes" @if($venta->tipo_venta === "1")  style="" @else style="display:none;" @endif>
                            <div class="form-group row">
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-12">
                                    <input type="text" name="personeriajuridica" id="personeriajuridica" value="{{ $venta->tipo_venta === "1" ? $venta->identificacion : "" }}" class="form-control" placeholder="Personeria Juridica - RIF">
                                </div>
                            </div> 
                            <div class="form-group row">
                                <label class="col-form-label col-lg-4 col-sm-12" for="representantelegal">Cedula Representante Legal *</label>
                                <div class="col-lg-7 col-md-7 col-sm-12">
                                    <input type="text" name="representantelegal" id="representantelegal" value="{{ $venta->tipo_venta === "1" ? $venta->representantelegal : "" }}" class="input-number form-control" placeholder="Cedula Representante Legal">
                                </div>
                            </div> 
                        </div>
                          <!--DIV SOHO-->
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-7 col-md-7 col-sm-12">
                                <input type="text" name="canton" id="canton" value="{{ $venta->canton }}" class="form-control" required placeholder="Canton">                                                                                                
                            </div>
                        </div> 
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-7 col-md-7 col-sm-12">
                                <input type="text" name="barrio" id="barrio" value="{{  $venta->barrio }}" class="form-control" required placeholder="Barrio">                                                                                                
                            </div>
                        </div> 
                        <div class="form-group row">
                        ...
                        <div id="inputsgpon" @if($venta->producto_id == 1) style="" @php $attr ="required"; @endphp @else style="display:none;" @php $attr =""; @endphp @endif>
                            <div class="form-group row">
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-12">
                                    <div class="input-group">
                                        <input type="text" name="coordenadas" id="coordenadas" {{$attr}} value="{{$venta->producto_id == 1 ? $venta->cordenadas : "" }}" class="form-control" placeholder="Cordenadas">                                                                                                
                                    </div>
                                </div>
                            </div> 
                            <div class="form-group row">
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-12">
                                    <div class="input-group">
                                        <input type="text" name="cantidadstb" id="cantidadstb" {{$attr}} value="{{ $venta->producto_id == 1 ? $venta->cantidad : "" }}" class="form-control" placeholder="Cantidad STB">                                                                                                
                                    </div>
                                </div>
                            </div> 
                        </div>
                        <div id="inputsmovil" @if($venta->producto_id == 2) style="" @php $attr2 ="required"; @endphp @else style="display:none;" @php $attr2 =""; @endphp @endif>
                            <div class="form-group row">
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-12">
                                    <div class="input-group">
                                        <input type="text" name="equipo" id="equipo" {{$attr2}} value="{{ $venta->producto_id == 2 ? $venta->equipo : "" }}" class="form-control" placeholder="Equipo">                                                                                                
                                    </div>
                                </div>
                            </div> 
                            <div class="form-group row">
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-12">
                                    <div class="input-group">
                                        <input type="text" name="portabilidad" id="portabilidad" {{$attr2}} value="{{ $venta->producto_id == 2 ? $venta->portabilidad : "" }}" class="form-control" placeholder="Portabilidad">                                                                                                
                                    </div>
                                </div>
                            </div> 
                        </div>
