...
@section('title','Claro Pymes|Listado de Ventas')
@section('content')
<!-- begin:: Subheader -->
        ...
        <div class="col-lg-12">
            ...
            <div class="kt-portlet">
                ...
                <div class="kt-portlet__body">        
                    <form method="POST" action="{{ route('claro.pymes.auditoriaSearch') }}" id="AuditSearch" class="kt-form kt-form--label-right">
                        @csrf      
                        <div class="row">
                    ...
                    <div class="modal fade" id="registerSegumiento">
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                ...
                                <h4 class="modal-title">Registrar Seguimiento Pymes</h4>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                                </div>
                                <form method="post" action="{{ route('claro.pymes.seguimientosStore') }}" id="formsegumientos">
                                    <input type="hidden" name="urlSeguimiento" id="urlSeguimiento" value="{{ route('claro.pymes.seguimientosItems') }}">
                                    @method('PUT')
                                    @csrf
