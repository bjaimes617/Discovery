        ...
        <div class="kt-portlet__body kt-portlet__body--fit">
            <div class="kt-grid  kt-wizard-v1 kt-wizard-v1--white" id="kt_contacts_add" data-ktwizard-state="step-first">
                ...
                <div class="kt-grid__item kt-grid__item--fluid kt-wizard-v1__wrapper">
                    ...
                    <form action="{{ route('user.store') }}" method="POST" id="kt_contacts_add_form" class="kt-form">
                    @csrf
                                        ...
                                        <div class="kt-section__body">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9 col-xl-9">
                                                    <input type="text" name="nombre_apellido" value="{{ old('nombre_apellido') }}" class="form-control" id="nombre_apellido" required>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-xl-3 col-lg-3 col-form-label">Usuario</label>
                                                <div class="col-lg-9 col-xl-9">
                                                    <input type="text" name="usuario" value="{{ old('usuario') }}" class="form-control" id="usuario" required data-check="{{ route('user.checkusername') }}">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9 col-xl-9">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" name="email" value="{{ old('email') }}" class="form-control" id="email" required data-check="{{ route('user.checkemail') }}">
                                                    </div>
                                                </div>
                                            </div>                                 
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9 col-xl-6">
                                                    <span class="kt-switch kt-switch--icon">
                                                        <label>
                                                            <input type="checkbox" name="auth2fa" id="auth2fa"/>
                                                            <span></span>
                                                        </label>
                                                    </span>
                                                </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9 col-xl-9">
                                                    <select name="roles[]" id="roles" class="form-control kt-select2 kt_select2_1" style="width: 100%">
                                                        <option value="" selected>[Seleccione]</option>
                                                        @foreach($roles as $key => $role)
                                                            <option value="{{ $key }}" {{ old('roles') == $key ? 'selected' : '' }}>{{ $role }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>                                                
                                    ...
                                    <div class="col-xl-12">
                                        <div class="kt-section__body">
                                            ...
                                            <div id="ficha_personal" style="display: none;">
                                                <div class="form-group row">
                                                    <label class="col-xl-3 col-lg-3 col-form-label">Usuario de Respond</label>
                                                    <div class="col-lg-9 col-xl-9">
                                                        <input type="text" name="user_response" value="{{ old('user_response') }}" class="form-control" id="user_response" required>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label class="col-xl-3 col-lg-3 col-form-label">N&uacute;mero de Empleado</label>
                                                    <div class="col-lg-9 col-xl-9">
                                                        <input type="text" name="numero_empleado" value="{{ old('numero_empleado') }}" class="form-control" id="numero_empleado" required data-check="{{ route('user.checknumeroempleado') }}">
                                                    </div>
                                                </div>                                               
                                                <div class="form-group row">
                                                    <label class="col-xl-3 col-lg-3 col-form-label">Fecha de Ingreso</label>
                                                    <div class="col-lg-9 col-xl-9">
                                                        <input type="text" name="fecha_ingreso" value="{{ old('fecha_ingreso') }}" class="form-control dater" id="fecha_ingreso" required placeholder="Seleccione una fecha">
                                                    </div>
                                                </div>
                                                <!--<div class="form-group row">
                                                    ...
                                                    <div class="col-lg-9 col-xl-9">
                                                        <div class="input-group date">
                                                            <input type="text" class="form-control" readonly placeholder="Seleccione una fecha" id="kt_datepicker_2" />
                                                    ...
                                                    <div class="col-lg-9 col-xl-9">
                                                        <select name="campania" id="campania" class="form-control kt-select2 kt_select2_1" style="width: 100%">
                                                            ...
                                                            @foreach($campanias as $key => $val)
                                                                <option value="{{ $key }}" {{ old('campania') == $key ? 'selected' : '' }}>{{ $val }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="col-lg-9 col-xl-9">
                                                        <select name="cargo" id="cargo" class="form-control kt-select2 kt_select2_1" style="width: 100%" required>
                                                            ...
                                                            @foreach($cargos as $key => $val)
                                                                <option value="{{ $key }}" {{ old('cargo') == $key ? 'selected' : '' }}>{{ $val }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="col-lg-9 col-xl-9">
                                                        <select name="jefe_inmediato" id="jefe_inmediato" class="form-control kt-select2 kt_select2_1" style="width: 100%">
                                                            ...
                                                            @foreach($jefes as $key => $val)
                                                                <option value="{{ $key }}" {{ old('jefe_inmediato') == $key ? 'selected' : '' }}>{{ $val }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-9 col-xl-9">
                                                        <select name="segundo_jefe_inmediato" id="segundo_jefe_inmediato" class="form-control kt-select2 kt_select2_1" style="width: 100%">
                                                            <option value="" selected>N/A</option>
                                                            @foreach($jefes as $key => $val)
                                                                <option value="{{ $key }}" {{ old('segundo_jefe_inmediato') == $key ? 'selected' : '' }}>{{ $val }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                </div>
...
@endpush
@push('scripts')
<script src="{{ asset("js/jquery.repeater/src/lib.js") }}"  type="text/javascript"></script> 
<script src="{{ asset("js/jquery.repeater/src/jquery.input.js") }}"  type="text/javascript"></script> 
<script src="{{ asset("js/jquery.repeater/src/repeater.js") }}"  type="text/javascript"></script> 
<script src="{{ asset("assets/js/pages/crud/forms/widgets/select2.js") }}"  type="text/javascript"></script> 
<script src="{{ asset("js/config/user.js") }}"  type="text/javascript"></script> 
@endpush
