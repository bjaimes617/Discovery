...
@section('title','Carga Masiva Usuarios')
@section('content')
        ...
        <div class="col">
            <div class="alert alert-light alert-elevate fade show" role="alert">
                ...
                <div class="alert-text">
                    Descargue el archivo de ejemplo, y asegurese de rellenar cada celda seg&uacute;n las indicaciones <small>(Ver los comentarios en el encabezado del archivo)</small>. <a class="kt-link kt-font-bold" href="{{ url('/').'/example/CargaEjemplo.xlsx'}}">Presione Aqu&iacute;</a>
                </div>
            </div>
        </div>
    </div>    
        ...
        <div class="kt-portlet__head kt-portlet__head--lg">
            <div class="kt-portlet__head-label">
                ...
                <h3 class="kt-portlet__head-title">
                    Carga Masiva <small>Solo operadores, los usuarios de mayor jerarquia asociados deben ser cargados previamente</small>
                </h3>
            </div>
