    ...
    <div class="kt-container ">
        <div class="kt-subheader__main">
            ...
            <div class="kt-subheader__breadcrumbs">
                <a href="#" class="kt-subheader__breadcrumbs-home"><i class="flaticon-squares"></i></a>
            ...
            <div class="kt-sc__top">
                <div class="kt-sc__content">
                    <h2 class="kt-sc__title">
                        Bienvenido a Discovery <br/><br/>
                        <img src="image/logo_directa.png" alt="Discovery" style="width: 30%;">
                    </h2> 
                    <br> 
                    @permission('bait.dashboard.metrics')
                        <h3 class="kt-sc__title">
                        Que Metricas Deseas Visualizar?<br/><br/>
                        <a href="{{ route('dashboard.bait') }}" class="btn btn-primary btn-lock"><i class="la la-signal"></i> Bait</a>                                          
                        </h3> 
                    @endpermission                   
                </div>            
            </div>
                ...
                <div class="kt-portlet__body">
                    <div class="kt-infobox">
                        <div class="kt-infobox__header">
                            <h2 class="kt-infobox__title">Conectando Emociones</h2>
                        </div>
                            ...
                            <div class="accordion accordion-light accordion--no-bg accordion-svg-icon" id="accordionExample1">
                                <div class="card">
                                    ...
                                    <div id="collapseOne1" class="collapse show" aria-labelledby="headingOne1" data-parent="#accordionExample1">
                                        <div class="card-body">
                                            Tu voluntad se encuentra siempre bajo tu control, por lo que nada puede detenerte, el único que puede lograr tus objetivos eres tú. Si algo afecta a tu determinación es porque tú lo permites.
                                        </div>
                                    </div>
                                </div>
                                <div class="card">
                                    <div class="card-header" id="headingTwo1">
                                        <div class="card-title collapsed" data-toggle="collapse" data-target="#collapseTwo1" aria-expanded="false" aria-controls="collapseTwo1">
                                            ...
                                            </svg> Aumenta tu Rendimiento
                                        </div>
                                    </div>
                                    <div id="collapseTwo1" class="collapse" aria-labelledby="headingTwo1" data-parent="#accordionExample1">
                                        <div class="card-body">
                                            Debes crear estrategias a largo plazo, tomando en cuenta tus capacidades y fortaleces para el trabajo individual y en equipo. Si detectas debilidades, tu labor es trabajar para minimizarlas, de manera que logres implementar un programa de ventas de acuerdo con los objetivos que te han establecido. La manera más eficiente de implementar una estrategia a largo plazo es a través de los líderes del equipo, apoyate en ellos recuerda que somos un solo equipo.
                                        </div>
                                    </div>
                                </div>
                                <div class="card">
                                    <div class="card-header" id="headingThree1">
                                        <div class="card-title collapsed" data-toggle="collapse" data-target="#collapseThree1" aria-expanded="false" aria-controls="collapseThree1">
                                            ...
                                            </svg> Conviertete en L&iacute;der
                                        </div>
                                    </div>
                                    <div id="collapseThree1" class="collapse" aria-labelledby="headingThree1" data-parent="#accordionExample1">
                                        <div class="card-body">
                                            Un verdadero líder sabe fijar unos objetivos y procurar los medios para alcanzarlos. Y eso requiere capacidad de planificación.  A menudo, la indecisión la falta de firmeza responden al miedo a equivocarse, a obtener malos resultados… en una palabra, a fracasar.
            ...
            <div class="kt-portlet kt-portlet--height-fluid kt-sc-2">
                <div class="kt-portlet__body">
                    <div class="kt-infobox kt-infobox--success">
                        <div class="kt-infobox__header">
                            <h2 class="kt-infobox__title">Mantente Enfocado</h2>
                        </div>
                        <div class="kt-infobox__body">
                            <img id="frases" width="100%" alt="Frases"/>
                        </div>
                    </div>
                </div>
            </div>
...
@endsection
@push('styles')
<link media="all" type="text/css" rel="stylesheet" href="{{asset('assets/css/pages/support-center/home-2.css')}}">
@endpush

@push('scripts')
<script>
    var description = [
        "{{ URL::asset('image/frases/1.png') }}",
        "{{ URL::asset('image/frases/2.png') }}",
        "{{ URL::asset('image/frases/3.png') }}",
        "{{ URL::asset('image/frases/4.png') }}",
        "{{ URL::asset('image/frases/5.png') }}",
        "{{ URL::asset('image/frases/6.png') }}",
        "{{ URL::asset('image/frases/7.png') }}",
        "{{ URL::asset('image/frases/8.png') }}",
        "{{ URL::asset('image/frases/9.png') }}",
        "{{ URL::asset('image/frases/10.png') }}",
        "{{ URL::asset('image/frases/11.png') }}",
        "{{ URL::asset('image/frases/12.png') }}",
        "{{ URL::asset('image/frases/13.png') }}"
    ];

    var size = description.length
    var x = Math.floor(size * Math.random())
    document.getElementById('frases').src = description[x];
</script>
@endpush
