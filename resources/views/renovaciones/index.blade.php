...
@section('title','Renovaciones|Listado de Ventas')
@section('content')
<!-- begin:: Subheader -->
        ...
        <div class="col-lg-12">
            ...
            <div class="kt-portlet">
                ...
                <div class="kt-portlet__body">        
                    <form method="POST" action="{{ route('renovaciones.search') }}" id="renovacionesSearch" class="kt-form kt-form--label-right">
                        @csrf      
                        <div class="row"> 
                            <div class="col-lg-4 col-md-12">
                                <label>Orden Onix:</label>
                                <div class="form-group ">
                                    <div class='input-group'>
                                        <input type='text' class="form-control" autocomplete="off" minlength="10" maxlength="10" name="numero_orden_onix" id="numero_orden_onix" placeholder="Orden Onix"/>
                                    </div> 
                                </div>                                     
                            </div>                           
                            <div class="col-lg-4 col-md-12">
