...
@section('title','Renovaciones|Editar')
@section('content')
<!-- begin:: Subheader -->
...
<div class="kt-container  kt-grid__item kt-grid__item--fluid">
        ...
        <div class="col-xl-12">            
            <div class="kt-portlet">
                ...
                <form method="POST" action="{{ route('renovaciones.update', $venta->id) }}" id="masivaAdd" class="kt-form kt-form--label-right">
                    @csrf   
                    @method('PUT')           
                      <div class="kt-portlet__body text-center">                           
                        <div class="form-group row">
                            ...
                            <div class="col-lg-7 col-md-12 col-sm-12">
                                <input type="text" name="dn" id="dn" value="{{ $venta->dn }}" class="form-control input-number" minlength="10" maxlength="10" data-check="{{ route('portabilidad.bait.check') }}" required placeholder="Numero a portar"> 
                            </div>
                        </div> 
                         <div class="form-group row">
                            <label class="col-form-label col-lg-4 col-sm-12" for="nombre_apellido">Nombre y Apellido <span style="color:red;">*</span></label>
                            <div class="col-lg-7 col-md-12 col-sm-12">
                                <input type="text" name="nombre_apellido" id="nombre_apellido" value="{{ $venta->nombre_cliente }}" class="form-control sinCaracteres" required placeholder="Nombre y Apellido"> 
                            </div>
                        </div> 
                         <div class="form-group row">
                            <label class="col-form-label col-lg-4 col-sm-12" for="equipo">Equipo <span style="color:red;">*</span></label>
                            <div class="col-lg-7 col-md-12 col-sm-12">
                                <input type="text" name="equipo" id="equipo" autocomplete="off"  value="{{ $venta->equipo }}" class="form-control" required placeholder="Equipo"> 
                            </div>
                        </div> 
                        <div class="form-group row">
                            ...
                            <div class="col-lg-7 col-md-12 col-sm-12">
                                ...
                                <select name="plazos" id="plazos"  class="form-control select" required>
                                    ...
                                    @foreach($plazos as $key => $value)
                                        <option value="{{ $value }}" {{ $venta->plazo == $value ? 'selected' : '' }}>{{ $value }} Meses</option>
                                    @endforeach
                                </select>
                                </div>
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-7 col-md-12 col-sm-12">
                                <div class="input-group"> 
                                    <input type="text" name="entrega_en" id="entrega_en" value="{{ $venta->entrega_en }}"  class="form-control " required placeholder="Domicilio"> 
                                </div>
                            </div>
                        </div>    
                        <div class="form-group row">
                            ...
                            <div class="col-lg-7 col-md-12 col-sm-12">
                                <input type="text" name="ordenonix" id="ordenonix" data-check='{{ route("renovaciones.check.dn") }}' autocomplete="off"  value="{{ $venta->numero_orden_onix }}" data-idventa="{{$venta->id }}" minlength="10" maxlength="10" class="form-control input-number" required placeholder="Nro de Orden ONIX"> 
                            </div>
                        </div> 
                        ...
                        <div class="form-group row">
                            <label class="col-form-label col-lg-4 col-sm-12" for="map">Seleccione la direccion <span style="color:red;">*</span></label>
                             <input type="hidden" id="corddefault" name="corddefault" data-zoom="18" data-cord="{!! $cordmap !!}">
                        ...
                        <div class="form-group row">
                         ...
                         <div class="form-group row">
                            ...
                            <div class="col-lg-7 col-md-12 col-sm-12">                             
                                <input type="text" id="referencia" name="referencia" required value="{{ $venta->referencias }}" class="form-control " placeholder="Punto de Referencia...">                                                                 
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-7 col-md-12 col-sm-12">                             
                                <input type="number" id="precio" name="precio"  required value="{{$venta->precio_equipo }}" class="form-control " placeholder="Precio del equipo...">                                                                 
                            </div>
                        </div>

                        <input type="hidden" id="latitud" name="latitud" value="{{ $venta->latitud }}">
                        <input type="hidden" id="longitud" name="longitud" value="{{ $venta->longitud }}">
