...
<html lang="en">
    ...
    <head>
        <base href="../../../">
        <meta charset="utf-8" />
        <title>Discovery - Plataforma de Portabilidad | @yield('title')</title>
        ...
        <link media="all" type="text/css" rel="stylesheet" href="{{asset('assets/plugins/general/ion-rangeslider/css/ion.rangeSlider.css')}}">
