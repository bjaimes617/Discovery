                ...
                <div class="kt-portlet__head">
                    <div class="kt-portlet__head-label">
                        <h3 class="kt-portlet__head-title">
                            Auditoria de Venta e Ingreso a Intelix
                        </h3>
                    </div>
                </div>                
                <form method="POST" action="{{ route('bait.backoffice.update', $venta->id) }}" id="auditoriaupdate" class="kt-form kt-form--label-right">
                    @csrf      
                    @method('PUT')        
                    <input type="hidden" name="id_venta" id="id_venta" value="{{ $venta->id }}" class="form-control">   
                    ...
                    <input type="hidden" name="observacionesAudit" id="observacionesAudit"  class="form-control"> 
                    <input type="hidden" name="folio" id="folio"  class="form-control"> 
                    <input type="hidden" name="check_rechazo" id="check_rechazo"  class="form-control"> 
                    <input type="hidden" name="estatus_intelix" id="estatus_intelix"  class="form-control"> 
