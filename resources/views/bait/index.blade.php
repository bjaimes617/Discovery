...
@section('title','BAIT|Listado de Ventas')
@section('content')
<!-- begin:: Subheader -->
                            ...
                            <div class="col-lg-4 col-md-12">
                                ...
                                <div class="form-group ">
                                    <div class='input-group'>
                                        <input type='text' class="form-control" autocomplete="off" minlength="10" maxlength="10" name="numero_portar" id="numero_portar" placeholder="Numero Portabilidad"/>
                                    </div> 
                                </div>                                     
                            </div>                           
                            <div class="col-lg-4 col-md-12">
