...
<div class="kt-container  kt-grid__item kt-grid__item--fluid">
        ...
        <div class="col-xl-12">            
            <div class="kt-portlet">
                ...
                <form method="POST" action="{{ route('bait.store') }}" id="masivaAdd" class="kt-form kt-form--label-right">
                    @csrf              
                      <div class="kt-portlet__body text-center">  
                        <div class="form-group row">
                            ...
                            <div class="col-lg-7 col-md-12 col-sm-12">
                                <input name="idcontacto" id="idcontacto" class="form-control input-number" value="{{ old('idcontacto') }}" maxlength="10" required placeholder="ID Contacto de Respond.io">                                
                            </div>
                        </div>   
                        <div class="form-group row">
                            ...
                            <div class="col-lg-7 col-md-12 col-sm-12">
                                <input type="text" name="numero_portabilidad" id="numero_portabilidad" value="{{ old('numero_portabilidad') }}" class="form-control input-number" minlength="10" maxlength="10" data-check="{{ route('portabilidad.bait.check') }}" required placeholder="Numero a portar"> 
                            </div>
                        </div> 
                         <div class="form-group row">
                         ...
                         <div class="form-group row">
                            ...
                            <div class="col-lg-7 col-md-12 col-sm-12">
                                <input type="text" name="fecha_nacimiento" id="fecha_nacimiento" autocomplete="off"  value="{{ old('fecha_nacimiento') }}" class="form-control datepicker_single" required placeholder="Fecha de Nacimiento"> 
                            </div>
                        </div> 
                        <div class="form-group row">
                            ...
                            <div class="col-lg-7 col-md-12 col-sm-12">
                                <select name="genero" id="genero" class="form-control" required>
                                    ...
                                    @foreach($sexo as $key => $value)
                                        <option value="{{ $key }}" {{ old('genero') == $key ? 'selected' : '' }}>{{ $value }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div> 
                         <div class="form-group row">
                           ...
                           <div class="col-lg-7 col-md-12 col-sm-12">
                                <div class="input-group"> 
                                    <input type="text" name="imei" id="imei" value="{{ old('imei') }}" class="form-control  input-number" minlength="15" maxlength="15" required placeholder="IMEI"> 
                                </div>
                            </div>
                        </div> 
                         <div class="form-group row">
                            ...
                            <div class="col-lg-7 col-md-12 col-sm-12">
                                <div class="input-group"> 
                                    <input type="text" name="codigo_nip" id="codigo_nip" value="{{ old('codigo_nip') }}" minlength="4"  maxlength="4" class="form-control input-number" required placeholder="Codigo NIP"> 
                                </div>
                            </div>
                        </div> 
                         <div class="form-group row">
                            ...
                            <div class="col-lg-7 col-md-12 col-sm-12">
                                <div class="input-group"> 
                                    <input type="text" name="fecha_vigencia" id="fecha_vigencia" autocomplete="off"  value="{{ old('fecha_vigencia') }}" class="form-control datepicker_single" required placeholder="Fecha de Vigencia"> 
                                </div>
                            </div>
                        </div>                         
                        <div class="form-group row">
                            ...
                            <div class="col-lg-7 col-md-12 col-sm-12">
                                ...
                                <select name="estado" id="estado" data-href="{{ route('bait.getMunicipio') }}"  class="form-control select" required>
                                    ...
                                    @foreach($estados as $value)
                                        <option value="{{ $value->id }}" {{ old('estado') == $value->id ? 'selected' : '' }}>{{ $value->estado }}</option>
                                    @endforeach
                                </select>
                                </div>
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-7 col-md-12 col-sm-12">
                                <b class="text-info"><p id="direccion_tienda"></p></b>
                            </div>
                        </div>
                         <div class="form-group row">
                            ...
                            <div class="col-lg-7 col-md-12 col-sm-12">
                                <div class="input-group"> 
                                    <input type="text" name="fecha_cita" id="fecha_cita" autocomplete="off" value="{{ old('fecha_cita') }}" class="form-control datepicker_single" required placeholder="Fecha de la Cita">    
                                                                  
                                        <input type="text" name="hora_cita" id="hora_cita" autocomplete="off" value="{{ old('hora_cita') }}" class="form-control datetimepickerHour" required placeholder="Hora de la Cita"> 
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-7 col-md-12 col-sm-12">
                                <div class="input-group"> 
                                    <input type="email" name="correo_electronico" id="correo_electronico" value="{{ old('correo_electronico') }}" class="form-control" required placeholder="Correo Electronico"> 
                                </div>
                            </div>
                        </div> 
                        <div class="form-group row">
                            ...
                            <div class="col-lg-7 col-md-12 col-sm-12">
                                <div class="input-group"> 
                                    <input type="text" name="telefono_contacto" id="telefono_contacto" value="{{ old('telefono_contacto') }}" class="form-control input-number" maxlength="10" required placeholder="Telefono de Contacto"> 
                                </div>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-lg-7 col-md-12 col-sm-12">
                                ...
                                <select name="fvc" id="fvc" class="form-control" required>
                                    ...
                                    @foreach($fvc as $key => $value)
                                        <option value="{{ $key }}" {{ old('fvc') == $key ? 'selected' : '' }}>{{ $value }}</option>
                                    @endforeach
                                </select>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-7 col-md-12 col-sm-12">
                                ...
                                <select name="gestion" id="gestion" class="form-control" required>
                                    ...
                                    @foreach($gestion as $key => $value)
                                        <option value="{{ $key }}" {{ old('gestion') == $key ? 'selected' : '' }}>{{ $value }}</option>
                                    @endforeach
                                </select>
                                </div>
                            </div>
