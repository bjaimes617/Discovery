                    ...
                    <div class="alert-text">
                        ...
                        @if (!Auth::user()->hasPermission('bait.cargador.payments'))
                            ...
                            Descargue el archivo de ejemplo para <span style="color:red; font-weight: bold;">Cargar los
                                ...
                                href="{{ Storage::disk('public')->url('formato_pagos_bait.xlsx') }}">Presione
                                Aqu&iacute;</a>
                        @endif
                    </div>
                </div>
            ...
            <div class="kt-portlet__head kt-portlet__head--lg">
                <div class="kt-portlet__head-label">
                    ...
                    <h3 class="kt-portlet__head-title">
                        Cargar Seguimientos PBackoffice <small>Utilice el formato suministrado para realizar el registro de
                            los seguimientos masivos</small>
                    </h3>
                </div>
            </div>
            <div class="kt-portlet__body">
                <form action="{{ route('bait.uploads.seguimientos.store') }}" method="POST" id="cargadorArchivo"
