    ...
    var form2 = function () {
        ...
        $("#AuditoriaUpdate").validate({
            ...
            submitHandler: function (form) {
                ...
                $(form)
                    .find(
                        "input[type=text]:visible,input[type=number]:visible,input[type=email]:visible, select:visible, textarea:visible",
                    )
                    .each(function () {
                ...
                if (botonPresionado === "aprobada") {
                    ...
                    mensaje =
                        "Está a punto de rechazar el registro y sus datos no serán enviados al GoogleSheet, Indique las observaciones del rechazo:<br><br>" +
...
$("#tipo_cliente").on("change", function () {
    switch (this.value) {
        case "0":
            $("#divAfiliados").show();
            $("#cedulatitular").prop("required", true);
            $("#ordenpatronal").prop("required", true);

            $("#divpymes").hide();
            $("#personeriajuridica").prop("required", false).val("");
            $("#representantelegal").prop("required", false).val("");

            $("#divsoho").hide();
            $("#cedulatitularpymes").prop("required", false).val("");
            break;
        case "1":
            $("#divAfiliados").hide();

            $("#cedulatitular").prop("required", false).val("");
            $("#ordenpatronal").prop("required", false).val("");

            $("#divpymes").show();
            $("#personeriajuridica").prop("required", true);
        ...
        case "2":
            ...
            $("#divsoho").show();
            $("#cedulatitularpymes").prop("required", true);
            break;
...
$("#producto").on("change", function () {
    ...
    switch (this.value) {
        case "1":
            $("#inputsgpon").show();
            $("#inputsmovil").hide();
            $("#cantidadstb").prop("required", true);
            $("#coordenadas").prop("required", true);
            $("#equipo").prop("required", false);
            $("#portabilidad").prop("required", false);
            break;
        case "2":
            $("#inputsgpon").hide();
            $("#inputsmovil").show();
            $("#cantidadstb").prop("required", false);
            $("#coordenadas").prop("required", false);
            $("#equipo").prop("required", true);
            $("#portabilidad").prop("required", true);
            break;
