...
var KTLoginGeneral = function () {
    ...
    //$.backstretch("theme/media/bg/bg-test.jpg");
    var login = $('#kt_login');

    var showErrorMsg = function (form, type, msg) {
        var alert = $('<div class="alert alert-' + type + ' alert-bold alert-dismissible" role="alert">\
        ...
        $('#kt_login_forgot_submit').click(function (e) {
            ...
            form.ajaxSubmit({
                ...
                success: function (response, status, xhr, $form) {
                    ...
                    setTimeout(function () {
                        KTApp.unprogress(btn[0]);
                        showErrorMsg(form, 'danger', 'Something is wrong...');
                    }, 1000);
                }
            });
        });
