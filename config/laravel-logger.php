...
return [
    ...
    */
    ...
    'loggerPaginationPerPage' => env('LARAVEL_LOGGER_PAGINATION_PER_PAGE', 30),
    ...
    */
    ...
    'loggerBladeExtended'       => env('LARAVEL_LOGGER_LAYOUT', 'layouts.main'),
    ...
    */
    ...
    'fontAwesomeCDN'            => env('LARAVEL_LOGGER_FONT_AWESOME_CDN_URL', public_path('/assets/plugins/general/plugins/flaticon/flaticon.css')),
